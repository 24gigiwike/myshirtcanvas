...
function BlankAboutPage({ onBack }: { onBack: () => void }) {
  return <main className="flex min-h-dvh items-center justify-center bg-[#fdfbf7] text-[#183b38]"><div className="text-center"><h1 className="text-4xl font-semibold tracking-tight">Get to know me</h1><button type="button" onClick={onBack} className="mt-8 rounded-full border border-[#183b38]/20 px-5 py-2 text-sm font-medium transition hover:bg-[#183b38] hover:text-white">Back to studio</button></div></main>
}
