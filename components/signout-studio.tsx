...
function AboutPage({ onBack }: { onBack: () => void }) {
  return <main className="flex min-h-dvh items-center justify-center bg-white text-slate-950"><div className="text-center"><h1 className="text-4xl font-semibold tracking-tight md:text-6xl">Get to know me</h1><button type="button" onClick={onBack} className="mt-8 rounded-full border border-slate-200 px-5 py-2 text-sm font-medium transition hover:bg-slate-950 hover:text-white">Back to Home</button></div></main>
}
