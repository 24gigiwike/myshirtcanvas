...
export function SignoutStudio() {
  ...
  const handleStampCreate = (point: THREE.Vector3, normal: THREE.Vector3) => {
    ...
    setStamps((current) => [...current, { id: Date.now(), textImage: textCanvas.toDataURL('image/png'), position: [point.x, point.y, point.z], rotation: [rotation.x, rotation.y, rotation.z], scale: [1.8, 1.8, 1.8] }])
  }
